...
fun NomzodItemBinding.setNomzod(nomzod: Nomzod,hasNomzod: Boolean, forDetails: Boolean = false) {
    typeView.apply {
        with(nomzod) {
            ...
            val photoShown = hasNomzod && photos.isNotEmpty()
            ...
            nameAgeView.setCompoundDrawablesWithIntrinsicBounds(container.context.getDrawable(if (type == KUYOV) R.drawable.man_ic else R.drawable.woman_ic),null,null,null)
